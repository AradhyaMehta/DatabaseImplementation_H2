...
public class Aggregate extends Expression {
     ...
     */
    static final int BIT_AND = 15;

    /**
     * The aggregate type for BIT_OR(expression)
     */
    static final int BIT_OR = 16;
    
    /**
     * The aggregate type for BIT_OR(expression)
     */
    static final int BIT_XOR = 17;
    ...
    public Expression optimize(Session session) {
        ...
        case BIT_OR:
        case BIT_XOR:
        	 if (!DataType.supportsBitOperations(dataType)) {
                 throw DbException.get(ErrorCode.SUM_OR_AVG_ON_WRONG_DATATYPE_1, getSQL());
             }
            break;
        default:
