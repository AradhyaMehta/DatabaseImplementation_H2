...
public class AlterTableAddConstraint extends SchemaCommand {
    ...
    private IncludeColumn[] includeColumns;
    private int deleteAction;
    private int updateAction;
    private Schema refSchema;
    private String refTableName;
    private IndexColumn[] refIndexColumns;
    private IncludeColumn[] refIncludeColumns;
    ...
    private int tryUpdate() {
        ...
        case CommandInterface.ALTER_TABLE_ADD_CONSTRAINT_PRIMARY_KEY: {
            ...
            IncludeColumn.mapColumns(includeColumns, table);
            ...
            if (index == null) {
                ...
                try {
                    index = table.addIndex(session, indexName, id,
                            indexColumns, indexType, true, null, includeColumns);
                } finally {
        ...
        case CommandInterface.ALTER_TABLE_ADD_CONSTRAINT_UNIQUE: {
            ...
            if (index != null && canUseUniqueIndex(index, table, indexColumns)) {
                ...
                if (index == null) {
                    index = createIndex(table, indexColumns, true, null);
                    isOwner = true;
                }
            }
            int id = getObjectId();
        ...
        case CommandInterface.ALTER_TABLE_ADD_CONSTRAINT_REFERENTIAL: {
            ...
            if (index != null && canUseIndex(index, table, indexColumns)) {
                ...
                if (index == null) {
                    index = createIndex(table, indexColumns, false, null);
                    isOwner = true;
                }
            }
            ...
            if (refIndex == null) {
                ...
                if (refIndex == null) {
                    refIndex = createIndex(refTable, refIndexColumns, true, null);
                    isRefOwner = true;
                }
            }
            int id = getObjectId();
    ...
    private Index createIndex(Table t, IndexColumn[] cols, boolean unique, IncludeColumn[] iCols) {
