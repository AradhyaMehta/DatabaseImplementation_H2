...
public class DataType {
    ...
    /**
     * Check if the given value type supports the bit operations.
     *
     * @param type the value type
     * @return true if bit operation is supported
     */
    public static boolean supportsBitOperations(int type) {
        switch (type) {
        case Value.BYTE:
        case Value.INT:
        case Value.LONG:
