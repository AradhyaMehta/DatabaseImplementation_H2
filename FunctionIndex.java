...
public class FunctionIndex extends BaseIndex {
    ...
    public FunctionIndex(FunctionTable functionTable, IndexColumn[] columns, IncludeColumn[] iColumns) {
        initBaseIndex(functionTable, 0, null, columns, IndexType.createNonUnique(true), iColumns);
