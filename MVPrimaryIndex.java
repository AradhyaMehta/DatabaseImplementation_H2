...
public class MVPrimaryIndex extends BaseIndex {
    ...
    private int mainIncludeColumn = -1;
    
    public MVPrimaryIndex(Database db, MVTable table, int id,
            IndexColumn[] columns, IndexType indexType, IncludeColumn[] iColumns) {
        this.mvTable = table;
        initBaseIndex(table, id, table.getName() + "_DATA", columns, indexType, iColumns);
    ...
    public void setMainIncludeColumn(int mainIncludeColumn) {
    	this.mainIncludeColumn = mainIncludeColumn;
    }
    ...
    public int getMainIncludeColumn() {
    	return mainIncludeColumn;
    }
