...
public class MetaIndex extends BaseIndex {
    ...
    public MetaIndex(MetaTable meta, IndexColumn[] columns, boolean scan, IncludeColumn[] iColumns) {
        initBaseIndex(meta, 0, null, columns, IndexType.createNonUnique(true), iColumns);
        this.meta = meta;
        this.scan = scan;
    }
