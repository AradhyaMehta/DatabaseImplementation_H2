...
public class MetaTable extends Table {
    ...
    public MetaTable(Schema schema, int id, int type) {
        ...
        if (indexColumnName == null) {
            ...
            includeColumn = getColumn(indexColumnName).getColumnId();
            IncludeColumn[] includeCols = IncludeColumn.wrap(new Column[] {cols[includeColumn]});
            metaIndex = new MetaIndex(this, indexCols, false, includeCols);
        }
    }
    ...
    public Index getScanIndex(Session session) {
        return new MetaIndex(this, IndexColumn.wrap(columns), true, null);
    }
    ...
    public ArrayList<Index> getIndexes() {
        ...
        list.add(new MetaIndex(this, IndexColumn.wrap(columns), true, null));
